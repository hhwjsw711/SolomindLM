...
export const mindmapGeneration = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.updateMindMapStatus, {
        mindmapId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio._helpers.initMindMapMapPhase, {
        mindmapId,
      ...
      await ctx.runMutation(internal.studio._helpers.markMindMapFailed, {
        mindmapId,
...
export const processMindMapMapChunk = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.storeMindMapMapResult, {
        mindmapId,
        chunkIndex,
...
export const finalizeMindMapPhase = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio._helpers.saveMindMapResults, {
        mindmapId,
      ...
      await ctx.runMutation(internal.studio._helpers.clearMindMapMapData, { mindmapId });
