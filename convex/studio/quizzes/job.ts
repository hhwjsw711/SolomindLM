...
export const quizGeneration = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.updateQuizStatus, {
        quizId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio._helpers.initQuizMapPhase, {
        quizId,
      ...
      await ctx.runMutation(internal.studio._helpers.markQuizFailed, {
        quizId,
...
export const processQuizMapChunk = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.storeQuizMapResult, {
        quizId,
        chunkIndex,
...
export const finalizeQuizPhase = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio._helpers.saveQuizResults, {
        quizId,
      ...
      await ctx.runMutation(internal.studio._helpers.clearQuizMapData, { quizId });
