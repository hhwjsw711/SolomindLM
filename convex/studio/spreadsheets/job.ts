...
export const spreadsheetGeneration = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.updateSpreadsheetStatus, {
        spreadsheetId,
        status: 'generating',
        metadata: {
          phase: 'initializing',
      ...
      await ctx.runMutation(internal.studio._helpers.initSpreadsheetMapPhase, {
        spreadsheetId,
      ...
      await ctx.runMutation(internal.studio._helpers.markSpreadsheetFailed, {
        spreadsheetId,
...
export const processSpreadsheetMapChunk = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      await ctx.runMutation(internal.studio._helpers.storeSpreadsheetMapResult, {
        spreadsheetId,
        chunkIndex,
...
export const finalizeSpreadsheetPhase = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      // Save results
      await ctx.runMutation(internal.studio._helpers.saveSpreadsheetResults, {
        spreadsheetId,
      ...
      await ctx.runMutation(internal.studio._helpers.clearSpreadsheetMapData, { spreadsheetId });
