...
export const PUBLIC_SEO_PAGES: PublicSeoPage[] = [
  ...
  {
    path: "/privacy",
    title: "Privacy Policy - Better Memory",
    description:
      "How Better Memory collects, uses, and shares information when you use our notebooks, sources, AI features, and billing.",
    changefreq: "monthly",
    priority: 0.3,
  ...
  {
    path: "/terms",
    title: "Terms of Service - Better Memory",
    description:
  ...
  },
  {
    ...
    description:
      "Answers about Better Memory study tools, research workflows, pricing, privacy, and how to get started with notebooks and sources.",
    keywords:
      "Better Memory FAQ, study tools help, research assistant questions, pricing limits, AI learning",
    changefreq: "weekly",
    priority: 0.7,
